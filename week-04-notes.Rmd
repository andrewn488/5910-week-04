...
+ include in fishbowl discussion - Dan Harmon's 7min apology for sexual abuse. This one resonated with me. 7 mins is short for a foot massage, but eternity for an apology. 

# Communication

+ Communication is the nervous system of a company
+ communication <- process of sharing information with individuals
+ "we're not seeing eye to eye" vs. "pull your head outta your ass" 
+ 3 basic elements to communication

    1. source/encoder - determines information to share, encodes that message and then transmits it to a destination
    2. signal - neutral media
    3. Decoder/Destination - decodes the information
...
+ non-verbal weighs more than verbal in messaging
+ communicating with stakeholders:

    + be upfront, honest, and transparent
    + know your audience and choose an appropriate communication style
    + always tell the truth - earn trust and build rapport
    + reach for a heart before you reach for a hand
    + tell stories
